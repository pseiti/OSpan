...
jsPsych.plugins["button-response-pseiti"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var alreadyClicked = "<p id='alreadyClicked'>Klikitud t\xE4hed: </p>" /*Already clicked letters:*/
    display_element.append(alreadyClicked);
    
    //display doneButton
    if (trial.showEndButton) {
      var doneButton = "<button id='doneButton' class='jspsych-btn'>Edasta meenutatud t\xE4hed</button></div>" /*Submit recalled letters*/
    ...
    function showClickedLetters (buttonsClicked){document.getElementById('alreadyClicked').innerHTML='Klikitud t\xE4hed <b>'+buttonsClicked.join(", ")};
